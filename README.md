...
* Template creates a [Jekyll] site that uses the [Just the Docs] theme. 
* To get started with creating a site like this, simply click "[use this template]" to create a GitHub repository.
...
[Browse documentation]: https://just-the-docs.github.io/just-the-docs/
